    ...
    <div id="projects">
      ...
      >
        ...
        <div className="relative w-full h-72 md:h-full">
          <img src="/images/project1.png" alt="Skill Nova" className="w-full h-full object-cover" />
        </div>
      ...
      >
        <div className="relative w-full h-72 md:h-full">
          <img src="/images/project2.png" alt="Bookoro" className="w-full h-full object-cover" />
        </div>
      ...
      >
        <div className="relative w-full h-72 md:h-full">
          <img src="/images/project3.png" alt="Hobby Hive" className="w-full h-full object-cover" />
        </div>
