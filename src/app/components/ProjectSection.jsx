...
const ProjectSection = () => {
    return (
        <div id='projects' className='mb-10 mt-0 md:mt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 p-6'>
                ...
                <div className="lg:col-span-5">
                    <CardContainer className="inter-var h-full">
                        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/10 dark:bg-black dark:border-white/20 border-black/10 w-full lg:h-[600px] rounded-xl p-6 border flex flex-col">
                            {/* Title */}
                            <CardItem
                                translateZ="50"
