                ...
                <div className="lg:col-span-7 bg-black">
                    <CardContainer className="inter-var h-full">
                        <CardBody className=" relative group/card hover:shadow-2xl hover:shadow-emerald-500/10 border-white/20 w-full lg:h-[600px] rounded-xl p-6 border flex flex-col">
                            ...
                            >
                                BuyNest – <span className="text-[#FF5005]"> E-Commerce Platform</span>
                            </CardItem>

                            <CardItem translateZ="100" className="w-full mt-4 overflow-hidden rounded-xl h-60">
                                <Image
                                    src={'/projects/buynestFull.png'}
                                    loading="eager"
                                    height={1000}
                                    width={1000}
                                    alt="thumbnail"
                            ...
                            >
                                BuyNest is a full-stack MERN e-commerce platform featuring secure authentication, role-based dashboards, SSLCommerz payment integration, downloadable PDF invoices, and an AI-powered chatbot using the Gemini API. Users can browse products, place orders, manage purchases, submit reviews, and track transactions, while admins can manage products, users, and orders through a dedicated dashboard. The platform is fully responsive and built with a focus on security, automation, and modern user experience.
                            </CardItem>
                            <CardItem
                                as="div"
                                translateZ="60"
                            ...
                            >
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <span className="bg-blue-500/20 text-gray-300 px-3 py-1 text-xs rounded-full">Gemini API</span>
                            ...
                            <div className="flex justify-start gap-2 items-center mt-6">
                                <CardItem
                                    translateZ={20}
                                    as="a"
                                    href="https://tools-final-projectt.web.app/"
                                    target="__blank"
                                ...
                                <CardItem
                                    translateZ={20}
                                    as="a"
                                    href="https://github.com/MasadRayan/Tools-Final-project-client"
                                    target="__blank"
